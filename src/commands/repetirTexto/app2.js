module.exports = async function(editor,textoUsuario,rep,regex1){
    //buscador de $ entre palabra ejemplo: sa$ff$
    let array1;
    ...
    const colaTextoUsuario = textoUsuario.slice(0,contenedorIndices[0])
    let fragmento = ""
    let repeticion = 1
    for(let i = 1;i <= repeticiones;i++){
        ...
        const palabraRepetida = `"${colaTextoUsuario}${fragmento}"`
