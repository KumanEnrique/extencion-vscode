...
module.exports = async function(res){
    ...
    const files = [".htaccess","index.php","README.md",".gitignore","config/autoload.php","config/request.php","config/router.php","libs/Controller.php","libs/Model.php","libs/Database.php","libs/View","views/partials/header.php","views/partials/footer.php"]
